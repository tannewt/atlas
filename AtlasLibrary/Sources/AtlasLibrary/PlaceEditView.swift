...
public struct PlaceEditView: View {
    ...
    public init(place: Place?, currentLocation: CLLocation?) {
        self.place = place
...
public struct TimeSlotEditView: View {
    @Environment(\.dismiss) private var dismiss
    ...
    public init(onSave: @escaping (TimeSlot) -> Void) {
        self.onSave = onSave
    }
